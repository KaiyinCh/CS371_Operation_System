...
public class MyMemoryAllocationTest {
	...
	private MyMemoryAllocation prepHoles(String algo) {
		...
		mal.alloc(1); //first fit: 1, best fit: 1, next fit: 1
		mal.alloc(3); //first fit: 2, best fit: 2, next fit: 2
		mal.alloc(2); //first fit: 5, best fit: 5, next fit: 5
		mal.alloc(2); //first fit: 7, best fit: 7, next fit: 7
		mal.alloc(1); //first fit: 9, best fit: 9, next fit: 9
		mal.alloc(1); //first fit: 10, best fit: 10, next fit: 10
		mal.alloc(1); //first fit: 11, best fit: 11, next fit: 11
		mal.alloc(2); //first fit: 12, best fit: 12, next fit: 12
		mal.free(2); //first fit: 2-3, best fit: 5-6, next fit: 2-3
		mal.free(7); //first fit: 0, best fit: 0, next fit: 0
		mal.free(10); //first fit: 0, best fit: 0, next fit: 0
		mal.free(12); //first fit: 0, best fit: 0, next fit: 0
		assert(mal.size() == 8);
